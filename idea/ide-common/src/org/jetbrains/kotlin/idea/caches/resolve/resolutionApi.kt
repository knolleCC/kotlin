...
fun KtDeclarationWithBody.analyzeWithBody(): BindingContext = analyzeFullyAndGetResult().bindingContext
...
@Deprecated(
    "Use either analyzeWithBody() or analyzeWithDeclarations() instead, or use just analyze()",
    ReplaceWith("analyze()")
)
